...
class LogisticRegression:
    ...
    def fit(self, x, y):
        ...
        if self.verbose:print(F"in the fit func and eps id {self.eps}")
        ...
        if self.verbose: print(F"the loop is over and is it <= eps {diff_between_theta <= self.eps} and diff_between_theta: {diff_between_theta}\n\n\n\n\n\n\n")
